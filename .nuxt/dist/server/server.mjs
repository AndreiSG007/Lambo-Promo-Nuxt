import { reactive, getCurrentInstance, version, toRef, isRef, inject, h, isReadonly, defineComponent, effectScope, onUnmounted, ref, computed, watch, Fragment, createVNode, Text, unref, resolveComponent, mergeProps, withCtx, toDisplayString, openBlock, createBlock, renderList, useSSRContext, provide, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
import { hasProtocol, parseURL, joinURL, isEqual, stringifyParsedURL, stringifyQuery, parseQuery, withLeadingSlash, encodeParam, encodePath } from "ufo";
...
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrRenderSuspense } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-a4503769.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-e7fce8df.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
