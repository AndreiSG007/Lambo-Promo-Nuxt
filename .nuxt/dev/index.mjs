globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/scule/dist/index.mjs';
import { hash } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/ufo/dist/index.mjs';
import { createStorage } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_KEBqBW = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KEBqBW, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KEBqBW, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/andreisoftgenius/Documents/LAMBO/lambo-promo-ohMySpins/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
