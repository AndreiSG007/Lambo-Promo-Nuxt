import { version, defineComponent, h, getCurrentInstance, inject, onUnmounted, useSSRContext, reactive, isReadonly, ref, computed, watch, Fragment, createApp, toRef, isRef, effectScope, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, Text, defineAsyncComponent, resolveComponent, mergeProps, withCtx, toDisplayString, openBlock, createBlock, renderList } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/unctx/dist/index.mjs';
import { useHead as useHead$1, createHead as createHead$1 } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/@unhead/dom/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/@unhead/ssr/dist/index.mjs';
import { hasProtocol, parseURL, joinURL, isEqual, encodeParam, stringifyParsedURL, stringifyQuery, parseQuery, withLeadingSlash, encodePath } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sendRedirect, appendHeader } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/h3/dist/index.mjs';
import { defu } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/defu/dist/defu.mjs';
import { useRouter as useRouter$1, useRoute as useRoute$1 } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/vue-router/dist/vue-router.node.mjs';
import { CoreWarnCodes, CompileErrorCodes, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, createCompileError, DEFAULT_LOCALE as DEFAULT_LOCALE$1, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, isTranslateFallbackWarn, isTranslateMissingWarn, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/@intlify/core-base/dist/core-base.mjs';
import { setupDevtoolsPlugin } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/vue-devtools-stub/dist/index.mjs';
import { VueDevToolsLabels, VueDevToolsPlaceholders, VueDevToolsTimelineColors } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/@intlify/vue-devtools/dist/vue-devtools.mjs';
import { parse, serialize } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/cookie-es/dist/index.mjs';
import isHTTPS from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/is-https/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/vue/server-renderer/index.mjs';
import VueEasyLightbox from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/vue-easy-lightbox/dist/vue-easy-lightbox.esm.min.js';
import { Swiper, SwiperSlide, useSwiper } from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/swiper/vue/swiper-vue.js';
import VueCountdown from 'file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/@chenfengyuan/vue-countdown/dist/vue-countdown.js';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [{ "rel": "icon", "type": "image/*", "href": "/favicon.ico" }], "style": [], "script": [], "noscript": [], "title": "Landing page" };
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/andreisoftgenius/Documents/lambo-promo-landingpage/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxRuntime$5BP3NseWHS = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$5BP3NseWHS, defaults: {} }
};
...
function requireShared() {
  ...
  shared.toDisplayString = toDisplayString2;
...
const locale_en = {
  "lastManStanding": (ctx) => {
    ...
    return _normalize(["Last Man Standing gets a"]);
  },
  "lamborghiniHuracan": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Lamborghini Huracan"]);
  },
  "howToWIN": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["How to win it:"]);
  },
  "placeAtLeast": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Place at least one casino or sports bet each day"]);
  },
  "keepDoingThatUntil": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Keep doing that until you are the only one left"]);
  },
  "hopOnThisAmazingLambo": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Hop on this amazing Lambo"]);
  },
  "termsAndConditions": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Terms and conditions"]);
  },
  "thePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The promotion starts on 5th of April and will continue until there is one player left."]);
  },
  "thePromotionIsOpen": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The promotion is open to all users who have registered at the casino before 23:59 on 4th of April"]);
  },
  "onceThePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Once the promotion starts no new entrants will be admitted."]);
  },
  "inOrderToParticipateIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["In order to participate in the promotion players must make at least one bet on the casino or on the sportsbook."]);
  },
  "missingOneDayOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Missing one day of betting will result in the elimination of the player from the promotion."]);
  },
  "theSystemTimeisInGMT": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The system time is in GMT. Therefore, the qualifying bet(s) need to be made between 00:00:01 GMT and 23:59:59 GMT to be considered for the promotion."]);
  },
  "atTheEndOfEachMonth": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["At the end of each month all surviving players will participate in a raffle for the win of an iPhone 14"]);
  },
  "theBigPrizeIsA2021": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The big prize is a 2021 Lamborghini Huracan or a cash equivalent."]);
  },
  "theWinningPlayerShould": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The winning player should investigate the local regulations concerning importing a car from the EU and any related taxes and registration fees."]);
  },
  "importTaxesAnd": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Import taxes and registration fees are not included in this promotion."]);
  },
  "ifThePromotionReaches": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["If the promotion reaches a stage where only 10 players are left, they can enter in agreement to share the prize in currency equivalent."]);
  },
  "theCurrencyEquivalentOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The currency equivalent of Lamborghini is EUR 250,000."]);
  },
  "theSiteGeneral": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The site general Terms and Conditions apply"]);
  },
  "thePrizeInAction": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The prize in action"]);
  },
  "aPlayerCanWinTheIphone": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["A player can win the iPhone prize only once during the course of this promotion."]);
  },
  "theMinimunAcumulated": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["The minimum accumulated daily betting amount for this promotion is EUR 10."]);
  },
  "days": (ctx) => {
    const { normalize: _normalize } = ctx;
  ...
  "playNow": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Play Now"]);
  },
  "promotionStartsIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Promotion starts in"]);
  }
};
const locale_de = {
  "lastManStanding": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Der „Last Man Standing“ erhält einen"]);
  },
  "lamborghiniHuracan": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Lamborghini Huracan"]);
  ...
  "howToWIN": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["So können Sie ihn gewinnen:"]);
  },
  "placeAtLeast": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Platzieren Sie mindestens einen Einsatz im Casino oder eine Sportwette pro Tag"]);
  },
  "keepDoingThatUntil": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Machen Sie so lange weiter, bis Sie der Einzige sind, der noch übrig ist."]);
  },
  "hopOnThisAmazingLambo": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Steigen Sie in diesen fantastischen Lambo ein"]);
  },
  "termsAndConditions": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Promotionsbedingungen"]);
  },
  "thePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Die Promotion beginnt am 05.April und wird fortgesetzt, bis nur noch ein Spieler übrig ist."]);
  },
  "thePromotionIsOpen": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Die Promotion steht allen Nutzern offen, die sich vor dem 04.April, 23:59 Uhr, im Casino registriert haben."]);
  },
  "onceThePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Sobald die Promotion beginnt, werden keine neuen Teilnehmer mehr zugelassen."]);
  },
  "inOrderToParticipateIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Um an der Promotion teilnehmen zu können, müssen Sie mindestens einen Einsatz im Casino oder bei den Sportwetten tätigen."]);
  },
  "missingOneDayOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Das Versäumen eines Einsatzes an einem Tag führt zum Ausschluss des Spielers von der Promotion."]);
  },
  "theSystemTimeisInGMT": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Die Systemzeit wird in GMT angegeben. Daher müssen die qualifizierenden Einsätze zwischen 00:00:01 Uhr GMT und 23:59:59 Uhr GMT getätigt werden, um an der Promotion teilnehmen zu können."]);
  },
  "atTheEndOfEachMonth": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Am Ende jedes Monats nehmen alle verbleibenden Spieler an einer Verlosung teil, bei der es ein iPhone 14 zu gewinnen gibt."]);
  },
  "theBigPrizeIsA2021": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Der große Preis ist ein 2021 Lamborghini Huracan oder der entsprechende Gegenwert in bar."]);
  },
  "theWinningPlayerShould": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Der Gewinner sollte sich über die lokalen Regulierungen für die Einfuhr eines Autos aus der EU und die damit verbundenen Steuern und Registrierungsgebühren informieren."]);
  },
  "importTaxesAnd": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Einfuhrsteuern und Registrierungsgebühren sind in dieser Promotion nicht enthalten."]);
  },
  "ifThePromotionReaches": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Wenn die Promotion eine Phase erreicht, in dem nur noch 10 Spieler übrig sind, können diese sich in einer Vereinbarung darauf einigen, den Preis in der entsprechenden Währung zu teilen."]);
  },
  "theCurrencyEquivalentOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Der entsprechende Wert des Lamborghini beträgt EUR 250.000."]);
  },
  "theSiteGeneral": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Es gelten die Allgemeinen Geschäftsbedingungen der Website"]);
  },
  "thePrizeInAction": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Der Preis in Aktion"]);
  },
  "aPlayerCanWinTheIphone": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Ein Spieler kann den iPhone-Preis nur einmal im Laufe dieser Promotion gewinnen."]);
  },
  "theMinimunAcumulated": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Der tägliche kumulierte Mindesteinsatz für diese Promotion beträgt EUR 10."]);
  },
  "days": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Tage"]);
  },
  "hours": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Stunden"]);
  },
  "minutes": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Minuted"]);
  },
  "seconds": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Sekunden"]);
  },
  "playNow": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Jetzt spielen"]);
  },
  "promotionStartsIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Die Aktion beginnt in"]);
  }
};
const locale_it = {
  "lastManStanding": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["L’Ultimo che Rimane vince una"]);
  },
  "lamborghiniHuracan": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Lamborghini Huracan"]);
  ...
  "howToWIN": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Come si vince:"]);
  },
  "placeAtLeast": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Effettua ogni giorno almeno una puntata al casinò o una scommessa sportiva."]);
  },
  "keepDoingThatUntil": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Continua fino a quando non sarai rimasto solo tu."]);
  },
  "hopOnThisAmazingLambo": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Sali su questa straordinaria Lambo"]);
  },
  "termsAndConditions": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Termini e Condizioni"]);
  },
  "thePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["La promozione inizia il 5 aprilie e continuerà fino a quando non rimarrà un solo giocatore."]);
  },
  "thePromotionIsOpen": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["La promozione è aperta a tutti gli utenti che si sono registrati al casinò prima delle 23:59 del 4 aprilie."]);
  },
  "onceThePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Una volta iniziata la promozione non saranno ammessi nuovi partecipanti."]);
  },
  "inOrderToParticipateIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Per partecipare alla promozione i giocatori devono effettuare almeno una puntata al casinò o una scommessa sportiva."]);
  },
  "missingOneDayOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["La mancata partecipazione a una giornata di puntate comporterà l'eliminazione del giocatore dalla promozione."]);
  },
  "theSystemTimeisInGMT": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["L'ora del sistema è in GMT. Pertanto, le puntate idonee devono essere effettuate tra le 00:00:01 GMT e le 23:59:59 GMT per essere valide ai fini promozionali."]);
  },
  "atTheEndOfEachMonth": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Alla fine di ogni mese, tutti i giocatori superstiti parteciperanno a un'estrazione per vincere un iPhone 14."]);
  },
  "theBigPrizeIsA2021": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Il primo premio è una Lamborghini Huracan del 2021 o un equivalente in denaro."]);
  },
  "theWinningPlayerShould": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Il giocatore vincente deve informarsi sulle normative locali relative all'importazione di un'auto dall'UE e sulle relative tasse e imposte di immatricolazione."]);
  },
  "importTaxesAnd": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Le tasse di importazione e le spese di registrazione non sono incluse in questa promozione."]);
  },
  "ifThePromotionReaches": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Se la promozione raggiunge una fase in cui sono rimasti solo 10 giocatori, questi possono accordarsi per condividere il premio nell’equivalente in valuta."]);
  },
  "theCurrencyEquivalentOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["L'equivalente in valuta della Lamborghini è di 250.000€."]);
  },
  "theSiteGeneral": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Si applicano i Termini e le Condizioni generali del sito"]);
  },
  "thePrizeInAction": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Il premio in azione:"]);
  },
  "aPlayerCanWinTheIphone": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Il giocatore può vincere l’iPhone come premio solo una volta nel corso di questa promozione."]);
  },
  "theMinimunAcumulated": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["L'importo minimo delle sommesse giornaliere accumulate per questa promozione è di 10 EUR."]);
  },
  "days": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Giorni"]);
  },
  "hours": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Ore"]);
  },
  "minutes": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Minuti"]);
  },
  "seconds": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Secondi"]);
  },
  "playNow": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Gioca ora"]);
  },
  "promotionStartsIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["La promozione inizia tra"]);
  }
};
const locale_fi = {
  "lastManStanding": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Viimeiseksi jäljellä oleva voittaa"]);
  },
  "lamborghiniHuracan": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Lamborghini Huracan"]);
  ...
  "howToWIN": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Näin voit voittaa sen:"]);
  },
  "placeAtLeast": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Aseta joka päivä vähintään yksi kasinopanos tai urheiluveto"]);
  },
  "keepDoingThatUntil": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Jatka samaa, kunnes olet ainoa jäljellä oleva"]);
  },
  "hopOnThisAmazingLambo": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Hyppää tämän upean Lambon kyytiin"]);
  },
  "termsAndConditions": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Ehdot"]);
  },
  "thePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Kampanja alkaa 5. huhtikuuta ja jatkuu, kunnes vain yksi pelaaja on jäljellä."]);
  },
  "thePromotionIsOpen": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Kampanja on avoin kaikille käyttäjille, jotka ovat rekisteröityneet kasinolle ennen 4. huhtikuuta kello 23.59."]);
  },
  "onceThePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Kampanjan alkaessa uusia osallistujia ei enää hyväksytä."]);
  },
  "inOrderToParticipateIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Osallistuakseen kampanjaan pelaajien on asetettava vähintään yksi panos/veto kasinolla tai urheiluvedonlyönnissä."]);
  },
  "missingOneDayOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Yhdenkin panostus-/vedonlyöntipäivän laiminlyönti johtaa pelaajan poistamiseen kampanjasta."]);
  },
  "theSystemTimeisInGMT": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Järjestelmän aika on GMT-aikaa. Näin ollen kelpoisuusehdot täyttävä(t) panos (panokset) tai veto (vedot) on asetettava klo 00.00.01 GMT ja 23.59.59 GMT välisenä aikana, jotta ne voidaan ottaa huomioon kampanjassa."]);
  },
  "atTheEndOfEachMonth": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Kunkin kuukauden lopussa kaikki jäljellä olevat pelaajat osallistuvat arvontaan, jossa voi voittaa iPhone 14:n."]);
  },
  "theBigPrizeIsA2021": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Pääpalkintona on vuoden 2021 Lamborghini Huracan tai sen arvoa vastaava rahasumma."]);
  },
  "theWinningPlayerShould": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Voittaneen pelaajan on selvitettävä auton EU:sta tuontiin liittyvät paikalliset määräykset ja mahdolliset verot ja rekisteröintimaksut."]);
  },
  "importTaxesAnd": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Tuontiverot ja rekisteröintimaksut eivät sisälly tähän kampanjaan."]);
  },
  "ifThePromotionReaches": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Jos kampanja saavuttaa vaiheen, jossa jäljellä on vain 10 pelaajaa, he voivat sopia palkinnon jakamisesta rahana."]);
  },
  "theCurrencyEquivalentOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Lamborghinin arvo on 250 000 euroa."]);
  },
  "theSiteGeneral": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Sivuston yleiset ehdot pätevät"]);
  },
  "thePrizeInAction": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Palkinto yksityiskohtaisesti:"]);
  },
  "aPlayerCanWinTheIphone": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Pelaaja voi voittaa iPhone-palkinnon tämän kampanjan aikana vain kerran."]);
  },
  "theMinimunAcumulated": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Tämän kampanjan pienin päivittäinen kokonaispanos on 10 euroa."]);
  },
  "days": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Päivää"]);
  },
  "hours": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Tuntia"]);
  },
  "minutes": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Minuuttia"]);
  },
  "seconds": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Sekuntia"]);
  },
  "playNow": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Pelaa nyt"]);
  },
  "promotionStartsIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Kampanja alkaa"]);
  }
};
const locale_pl = {
  "lastManStanding": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Ostatnia osoba na pokładzie otrzyma"]);
  },
  "lamborghiniHuracan": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Lamborghini Huracan"]);
  ...
  "howToWIN": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Jak wygrać:"]);
  },
  "placeAtLeast": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Postaw przynajmniej jeden zakład kasynowy lub zakład sportowy każdego dnia."]);
  },
  "keepDoingThatUntil": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Rób tak dalej, aż zostaniesz tylko Ty."]);
  },
  "hopOnThisAmazingLambo": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Wskocz do tego niesamowitego Lambo"]);
  },
  "termsAndConditions": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Regulamin"]);
  },
  "thePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Promocja rozpoczyna się 5 kwietnia i będzie trwać do momentu, aż zostanie tylko jeden gracz."]);
  },
  "thePromotionIsOpen": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Z promocji mogą skorzystać wszyscy użytkownicy, którzy zarejestrowali się w kasynie 4 kwietnia przed godziną 23:59."]);
  },
  "onceThePromotionStarts": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Po rozpoczęciu promocji nowi uczestnicy nie będą już przyjmowani."]);
  },
  "inOrderToParticipateIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Aby wziąć udział w promocji, gracze muszą postawić co najmniej jeden zakład kasynowy lub sportowy."]);
  },
  "missingOneDayOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Opuszczenie jednego dnia obstawiania skutkuje eliminacją gracza z promocji."]);
  },
  "theSystemTimeisInGMT": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Czas systemowy jest podany w GMT. W związku z tym kwalifikujące się zakłady muszą być postawione pomiędzy 00:00:01 GMT a 23:59:59 GMT, aby zostać uwzględnionymi w promocji."]);
  },
  "atTheEndOfEachMonth": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Pod koniec każdego miesiąca wszyscy pozostający na pokładzie gracze wezmą udział w loterii, w której do wygrania będzie iPhone 14."]);
  },
  "theBigPrizeIsA2021": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Nagrodą główną jest Lamborghini Huracan z 2021 roku lub ekwiwalent pieniężny."]);
  },
  "theWinningPlayerShould": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Wygrywający gracz powinien sprawdzić lokalne przepisy dotyczące importu samochodu z UE oraz wszelkie związane z tym podatki i opłaty rejestracyjne."]);
  },
  "importTaxesAnd": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Podatki importowe i opłaty rejestracyjne nie są uwzględnione w tej promocji."]);
  },
  "ifThePromotionReaches": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Gdy promocja osiągnie etap, w którym pozostanie tylko 10 graczy, mogą oni zawrzeć umowę o podziale nagrody o równowartości pieniężnej."]);
  },
  "theCurrencyEquivalentOf": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Równowartość pieniężna Lamborghini wynosi 250 000 euro."]);
  },
  "theSiteGeneral": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Obowiązuje ogólny regulamin korzystania ze strony internetowej"]);
  },
  "thePrizeInAction": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Nagroda w akcji:"]);
  },
  "aPlayerCanWinTheIphone": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["W trakcie tej promocji gracz może wygrać iPhone'a tylko raz."]);
  },
  "theMinimunAcumulated": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Minimalna skumulowana dzienna kwota zakładów w ramach tej promocji to 10 EUR."]);
  },
  "days": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Dni"]);
  },
  "hours": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Godzyni"]);
  },
  "minutes": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Minuty"]);
  },
  "seconds": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Sekundy"]);
  },
  "playNow": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Zagraj"]);
  },
  "promotionStartsIn": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Promocja zaczyna się za"]);
  }
};
const localeCodes = ["en", "de", "it", "fi", "pl"];
...
const additionalMessages = Object({ "de": [], "it": [], "fi": [], "pl": [] });
const resolveNuxtI18nOptions = async (context) => {
  ...
  nuxtI18nOptions.locales = [Object({ "code": "en", "file": "en.json", "path": "/Users/andreisoftgenius/Documents/lambo-promo-landingpage/lang/en.json" }), Object({ "code": "de", "file": "de.json", "path": "/Users/andreisoftgenius/Documents/lambo-promo-landingpage/lang/de.json" }), Object({ "code": "it", "file": "it.json", "path": "/Users/andreisoftgenius/Documents/lambo-promo-landingpage/lang/it.json" }), Object({ "code": "fi", "file": "fi.json", "path": "/Users/andreisoftgenius/Documents/lambo-promo-landingpage/lang/fi.json" }), Object({ "code": "pl", "file": "pl.json", "path": "/Users/andreisoftgenius/Documents/lambo-promo-landingpage/lang/pl.json" })];
...
const _imports_0 = "" + __publicAssetsURL("assets/OMS_logo.svg");
const _imports_1 = "" + __publicAssetsURL("assets/Header_group_OMS.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-container" }, _attrs))}><div class="main-wrapper"><img${ssrRenderAttr("src", _imports_0)} alt="" class="main-logo" w="190" h="36"><div class="main-texts"><h2>${ssrInterpolate(_ctx.$t("lastManStanding"))}</h2><h1>${ssrInterpolate(_ctx.$t("lamborghiniHuracan"))}</h1></div><div class="counter-container"><h3>${ssrInterpolate(_ctx.$t("promotionStartsIn"))}</h3>`);
  _push(ssrRenderComponent(_component_no_ssr, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_vue_countdown, { time: _ctx.time }, {
          default: withCtx(({ days, hours, minutes, seconds }, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="counter-container_labels"${_scopeId2}><div class="counter-container_labels-container"${_scopeId2}><p class="counter-container_labels-container-number day"${_scopeId2}>${ssrInterpolate(days)}</p><p class="counter-container_labels-container-text"${_scopeId2}>${ssrInterpolate(_ctx.$t("days"))}</p></div><div class="counter-container_labels-container"${_scopeId2}><p class="counter-container_labels-container-number hour"${_scopeId2}>${ssrInterpolate(hours)}</p><p class="counter-container_labels-container-text"${_scopeId2}>${ssrInterpolate(_ctx.$t("hours"))}</p></div><div class="counter-container_labels-container"${_scopeId2}><p class="counter-container_labels-container-number minute"${_scopeId2}>${ssrInterpolate(minutes)}</p><p class="counter-container_labels-container-text"${_scopeId2}>${ssrInterpolate(_ctx.$t("minutes"))}</p></div><div class="counter-container_labels-container"${_scopeId2}><p class="counter-container_labels-container-number seconds"${_scopeId2}>${ssrInterpolate(seconds)}</p><p class="counter-container_labels-container-text"${_scopeId2}>${ssrInterpolate(_ctx.$t("seconds"))}</p></div></div>`);
            } else {
              return [
                createVNode("div", { class: "counter-container_labels" }, [
                  createVNode("div", { class: "counter-container_labels-container" }, [
                    createVNode("p", { class: "counter-container_labels-container-number day" }, toDisplayString(days), 1),
                    createVNode("p", { class: "counter-container_labels-container-text" }, toDisplayString(_ctx.$t("days")), 1)
                  ]),
                  createVNode("div", { class: "counter-container_labels-container" }, [
                    createVNode("p", { class: "counter-container_labels-container-number hour" }, toDisplayString(hours), 1),
                    createVNode("p", { class: "counter-container_labels-container-text" }, toDisplayString(_ctx.$t("hours")), 1)
                  ]),
                  createVNode("div", { class: "counter-container_labels-container" }, [
                    createVNode("p", { class: "counter-container_labels-container-number minute" }, toDisplayString(minutes), 1),
                    createVNode("p", { class: "counter-container_labels-container-text" }, toDisplayString(_ctx.$t("minutes")), 1)
                  ]),
                  createVNode("div", { class: "counter-container_labels-container" }, [
                    createVNode("p", { class: "counter-container_labels-container-number seconds" }, toDisplayString(seconds), 1),
                    createVNode("p", { class: "counter-container_labels-container-text" }, toDisplayString(_ctx.$t("seconds")), 1)
                  ])
                ])
              ];
            }
        ...
        return [
          createVNode(_component_vue_countdown, { time: _ctx.time }, {
  ...
  _push(`</div><button class="main-button">${ssrInterpolate(_ctx.$t("playNow"))}</button><div><img${ssrRenderAttr("src", _imports_1)} alt="" class="main-image"></div><div class="steps"><h2 class="steps-title">${ssrInterpolate(_ctx.$t("howToWIN"))}</h2><div class="steps-container"><div class="step">`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "/assets/1.svg",
    alt: "",
    class: "step-image"
  }, null, _parent));
  _push(`<h2>${ssrInterpolate(_ctx.$t("placeAtLeast"))}</h2></div><div class="step">`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "/assets/2.svg",
    alt: "",
    class: "step-image"
  }, null, _parent));
  _push(`<h2>${ssrInterpolate(_ctx.$t("keepDoingThatUntil"))}</h2></div><div class="step">`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "/assets/3.svg",
    alt: "",
    class: "step-image"
  }, null, _parent));
  _push(`<h2>${ssrInterpolate(_ctx.$t("hopOnThisAmazingLambo"))}</h2></div></div></div><div class="bottom-gallery"><h2 class="bottom-gallery-text">${ssrInterpolate(_ctx.$t("thePrizeInAction"))}</h2><iframe src="https://www.youtube.com/embed/u8Oqaxf4r94" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><div class="swiper-container">`);
  _push(ssrRenderComponent(_component_swiper, {
    ref: { swiperRef: _ctx.swiperRef },
    slidesPerView: 2,
    "space-between": 20,
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<!--[-->`);
        ssrRenderList(_ctx.imgs, (src, index) => {
        ...
        return [
          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.imgs, (src, index) => {
  ...
  _push(`<div class="arrows-container">`);
  _push(ssrRenderComponent(_component_nuxt_img, { src: "/assets/left-arrow.svg" }, null, _parent));
  _push(ssrRenderComponent(_component_nuxt_img, { src: "/assets/right-arrow.svg" }, null, _parent));
  _push(`</div></div>`);
  ...
  _push(`<div class="modal-overlay" style="${ssrRenderStyle(_ctx.showModal ? null : { display: "none" })}"><div class="modal"><h6>Saved!</h6><p>Your Details have been saved Successfully</p><button>Go Home</button></div><div class="close"><button>X</button></div></div><footer><button><u>${ssrInterpolate(_ctx.$t("termsAndConditions"))}</u></button><p> OhMySpins.com is operated by Buton Group and operating under Curacao license No. 8048/JAZGambling can be addictive. Play responsibly. OhMySpins only accepts customers over 18 years of age. 2023© OhMySpins.com All rights reserved </p></footer></div></div></div>`);
}
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-a4503769.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-e7fce8df.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
